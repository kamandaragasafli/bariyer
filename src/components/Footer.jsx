    ...
    <footer id="contact" className="footer">
      ...
      <div className="footer-container">
        <div className="footer-brand">
          <h2 className="footer-logo">BARİYER PM</h2>
          <p className="footer-tagline">Səsin nəzarəti sizin əlinizdə</p>
          <div className="footer-social">
            <a href="https://www.instagram.com/ses_izolyasiyasi" target="_blank" rel="noopener noreferrer" className="social-icon social-icon-instagram" aria-label="Instagram">
              <IconInstagram />
            </a>
            <a href="https://www.tiktok.com/@bariyer.pm" target="_blank" rel="noopener noreferrer" className="social-icon social-icon-tiktok" aria-label="TikTok">
              <IconTikTok />
            </a>
            <a href="https://www.facebook.com/share/1QuUhaBfHT/" target="_blank" rel="noopener noreferrer" className="social-icon social-icon-facebook" aria-label="Facebook">
              <IconFacebook />
            </a>
            <a href="https://wa.me/994502000549" target="_blank" rel="noopener noreferrer" className="social-icon social-icon-whatsapp" aria-label="WhatsApp">
              <IconWhatsApp />
            </a>
          </div>
        </div>
        ...
        <div className="footer-links">
          <div className="footer-column">
            <h3 className="footer-column-title">Əlaqə</h3>
            <div className="footer-contact-item">
              <IconPhone />
              <a href="tel:0552400295">0552400295</a>
            </div>
            <div className="footer-contact-item">
              <IconMail />
          ...
          <div className="footer-column">
            <h3 className="footer-column-title">Səhifələr</h3>
            <a href="#services" className="footer-link">Xidmətlər</a>
            <a href="#projects" className="footer-link">Layihələr</a>
            <a href="#about" className="footer-link">Haqqımızda</a>
            <a href="#blog" className="footer-link">Blog</a>
          </div>

          <div className="footer-column">
            <h3 className="footer-column-title">Məlumat</h3>
            <div className="footer-contact-item">
              <IconGlobe />
              <span>bariyerpm.az</span>
            </div>
            <p className="footer-info">Səs izolyasiyası və akustik həllər üzrə peşəkar xidmət</p>
          </div>
        </div>
      </div>
      ...
      <div className="footer-bottom">
        ...
        <p className="footer-copyright">
          © {new Date().getFullYear()} BARİYER PM. Bütün hüquqlar qorunur.
        </p>
      </div>
    </footer>
  )
